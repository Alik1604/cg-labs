...
const AffineTransformations = () => {
    ...
    const handleSystemInputChange = (event: any) => {
        ...
        setSystemInputs({...systemInputs, [event.target.name]: event.target.value});
    };
    ...
    const handleTriangleInputChange = (event: any) => {
        ...
        const newTriangleInputs = {...triangleInputs, [event.target.name]: event.target.value}
    ...
    const startAnimation = () => {
        ...
        let newTrianglePoints: React.SetStateAction<{ a: Point; b: Point; c: Point; }> | undefined
        let newCanvasConfigs: React.SetStateAction<{ originX: number; originY: number; oneLengthX: number; oneLengthY: number; }> | undefined
        let i = 1
        ...
        const animateTriangle = () => {
            ...
            if (delayRef.current > 0) {
                ...
                newTrianglePoints = newTrianglePoints === undefined ? getNewTriangle(
                    trianglePoints,
                    triangleInputs.x,
                    triangleInputs.y,
                ...
                console.log(newTrianglePoints.a, newTrianglePoints.b, newTrianglePoints.c)
    ...
    useEffect(() => {
        ...
        drawResult ? drawTriangle(canvasRef, drawResult, trianglePoints) : drawTriangle(canvasRef, canvasConfigs, trianglePoints)
        ...
        <main className="flex max-h-screen flex-row bg-white">
            ...
            <div className="flex flex-row flex-grow p-12 bg-[#108A00] bg-opacity-5 overflow-auto">
                ...
                <div className="flex-grow mt-4 p-4">
                    <canvas className="border" ref={canvasRef} width={canvasSize.width} height={canvasSize.height}/>
                    <br/>
                ...
                <div className="space-y-4 text-black border p-3">
                    ...
                    <div className="flex gap-4">
                        <Button
                            onClick={animationStartedForUi ? stopAnimation : startAnimation}>{animationStartedForUi ? "Зупинити рух" : "Почати рух"}</Button>
                    </div>
                </div>
            </div>
        </main>
